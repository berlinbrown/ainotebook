 ...
 */
public class TestChromosome extends Chromosome<Integer> {

	protected TestCity cities[];

	TestChromosome(final TestTSPGeneticAlgorithm owner, final TestCity cities[]) {
